...
**Execution outcome (2026-07-…).** *(To be filled after execution: commits, coverage numbers, real-data IT result, maintainer render verdict, any plan corrections forced by real data — matching the M1/M2 execution-outcome sections.)*
